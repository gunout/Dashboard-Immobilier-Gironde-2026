# dashboard_gironde_2025.py – version définitive avec rues (scatter_map)
    ...
    if not df_carte.empty:
        ...
        try:
            fig = px.scatter_map(
                ...
                size_max=15,
                zoom=13,  # Zoom plus serré pour voir les rues
                map_style="open-street-map",  # Affiche les noms de rues
